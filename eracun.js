  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      ...
      stmt.run(polja["FirstName"], polja["LastName"], polja["Company"], polja["Address"], polja["City"], 
               polja["State"], polja["Country"], polja["PostalCode"], polja["Phone"], 
    ...
    if (napaka2 == false) {
      sporociloPoRegistraciji = "Stranka je bila uspešno registrirana."; 
    }
    else {
      sporociloPoRegistraciji = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
    }
    
    vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
        odgovor.render('prijava', {sporocilo: sporociloPoRegistraciji, seznamStrank: stranke, seznamRacunov: racuni});  
      }) 
    });
